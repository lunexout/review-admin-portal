...
export function DataTableSkeleton({
  ...
  return (
    <div className="flex w-full flex-col gap-y-5 overflow-auto">
      ...
      {/* TODO: [20] Make sure spacing matches the actual table */}
      {filterableColumnCount > 0 && (
        <div className="flex w-full p-1">
          ...
          {filterableColumnCount > 0 && (
            <Skeleton className="ml-auto hidden h-7 w-[70px] shrink-0 lg:flex" />
          )}
        </div>
      )}
